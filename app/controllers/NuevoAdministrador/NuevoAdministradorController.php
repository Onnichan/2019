<?php 
  ...
  require ROOT . "/esis.library.unjbg/app/models/NuevoAdministrador/NuevoAdministradorModel.php";
  require ROOT . "/esis.library.unjbg/system/libs/Session.php";

  class NuevoAdministradorController extends Controller
{
  private $session;
  private $model;
  ...
  public function __construct()
  {
    ...
    $this->model = new NuevoAdministradorModel();
  }
