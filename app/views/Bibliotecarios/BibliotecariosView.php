				...
				<div class="col-md-9 col-lg-10 float-right">
					<div class="mt-3">
						<ul class="breadcrumb p-2">
							...
							<li class="breadcrumb-item"><a href="">Bibliotecarios</a></li>
						</ul>
					</div>	
					<div>
						<div class="d-flex">
							<div class="float-left">
								<h4 style="color:#7C3A3A"><b>Bibliotecarios</b></h4>
							</div>
							<div class="float-left">
								<a href="/esis.library.unjbg/NuevoLibro/CargarDatos" class="btn btn-sm btn-primary ml-3">Nuevo</a>
							</div>
						</div>
						<div class="mt-3">
							...
							<table class="table table-striped">
						      ...
						      <tbody>
						        <?php
						        while ($row = $bibliotecario->fetch_array())
						        {
						          echo '<tr>';
						          ...
						          echo "<td><a href='" . FOLDER_PATH ."/Bibliotecarios/MostrarBibliotecarios/{$row['id_usuario']}'>Editar</a></td>";
						          echo "<td><a href='" . FOLDER_PATH ."/Bibliotecarios/EliminarBibliotecarios/{$row['id_usuario']}'>Eliminar</a></td>";
						          echo '</tr>';
						        }
						        ?>
						      </tbody>
