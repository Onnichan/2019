...
<body>
    ...
    <main id="programa">
        ...
        <section class="wrapper" id="intro">
            ...
            <article>
                <p>La organización del pre Congreso: “XX Congreso Internacional de Informática y 
                    Sistemas – CIIS 2019”. El desarrollo de las actividades programadas como los talleres de 
                    verano están dispuestas para el publico estudiantil de pre-universitario, estudiantes universitarios, 
                    los de pre-grado y profesionales. Con el objetivo de que el estudiante desarrolle el aprendizaje 
                    y conozca aun más la tecnología</p>
                <p>Para acceder a los <b><a>talleres
                            es necesario inscribirse</a></b> a cada uno de ellos.</p>
            </article>
        </section>
        ...
        <section id="content">
            <div class="wrapper">
                <div class="day">
                    <button id="labA" class="active">Laboratorio A</button>
                    <button id="labB">Laboratorio B</button>
                    <button id="labC">Laboratorio C</button>
                </div>
            </div>
            
            <div id="labA" class="schedule">
                <div class="tracks">
                    <div class="track1">
                        <h4>Lunes</h4>
                    </div>
                ...
                <div class="slot" time="08:00">
                    <span></span>
                    <a class="talk track1" href="#" data-location="Lunes"
                        data-tags="">
                        <h5>Taller de AutoCAD 2D y 3D e impresión 3D</h5>
                        <div class="schedule-row">
                            <div>
                                <p>Est. María F. Zevallos Gómez </br> Est. Jesús Joseph Yance Flores</p>
                            </div>
                        </div>
                    </a>

                    <a class="talk track2" href="#" data-location="Martes"
                        data-tags="">
                        <h5>Taller de robótica con LEGO Mindstorms NXT 2.0 y EV3</h5>
                        <div class="schedule-row">
                            <div>
                                <p>Ing. Hugo Manuel Barraza Vizcarra</p>
                            </div>
                        </div>
                    </a>

                    <a class="talk track3" href="#" data-location="Miercoles"
                        data-tags="">
                        <h5>Taller de AutoCAD 2D y 3D e impresión 3D</h5>
                        <div class="schedule-row">
                            <div>
                    ...
                    <a class="talk track4" href="#" data-location="Jueves"
                        data-tags="">
                        <h5>Taller de robótica con LEGO Mindstorms NXT 2.0 y EV3</h5>
                        <div class="schedule-row">
                            <div>
                    ...
                    <a class="talk track5" href="#" data-location="Viernes"
                        data-tags="">
                        <h5>Taller de AutoCAD 2D y 3D e impresión 3D</h5>
                        <div class="schedule-row">
                            <div>
                ...
                <div class="slot" time="11:00">
                    ...
                    <a class="talk track2" href="#"
                        ...
                        <div class="schedule-row">
                            <div>
                                <p>Est. Jesús Jarol Cervantes Tapia</p>
                            </div>
                        </div>
                    </a>
            ...
            <div id="labB" class="schedule" style="display: none">
                <div class="tracks">
                    <div class="track1">
                        <h4>Lunes</h4>
                    </div>
                ...
                <div class="slot" time="08:00">
                    ...
                    <a class="talk track2" href="#" data-location="Martes"
                        ...
                        <div class="schedule-row">
                            <div>
                                <p>Est. Ruth Ramirez Rejas</br>Est. Jakelyn Sintecala Mulluni</p>
                            </div>
                        </div>
                    </a>
                ...
                <div class="slot" time="10:15">
                    ...
                    <a class="talk track1" href="#"
                        ...
                        <div class="schedule-row">
                            <div>
                                <p>Est. Alexis Condori Catunta</p>
                            </div>
                        </div>
                    </a>
                    <a class="talk track2" href="#"
                        ...
                        <div class="schedule-row">
                            <div>
                                <p>Est. Fressia Ramos Huanca</br>Est. Richard Pongo Cama</p>
                            </div>
                        </div>
                    </a>
                    <a class="talk track3" href="#"
            ...
            <div class="tracks">
                ...
                <div class="slot" time="08:00">
                    ...
                    <a class="talk track1" href="#" data-location="Lunes"
                        ...
                        <div class="schedule-row">
                            <div>
                                <p>Ing. Wilson Calizaya Choquecota</br>
                                Est. Leandro Ramos Valdez</br>
                                Est. Josué Mamani Cariapaza</p>
                            </div>
                        </div>
                    </a>
                ...
                <div class="slot" time="10:15">
                    ...
                    <a class="talk track1" href="#"
                        ...
                        <div class="schedule-row">
                            <div>
                                <p>Est. Aracely Mamani Siña</br>Est. Brayan Mamani Salamanca</p>
                            </div>
                        </div>
                    </a>
                    <a class="talk track2" href="#"
