				...
				<div class="col-md-9 col-lg-10 float-right">
					<div class="mt-3">
						<ul class="breadcrumb p-2">
							...
							<li class="breadcrumb-item"><a href="/esis.library.unjbg/Articulo/MostrarArticulos">Artículo</a></li>
							<li class="breadcrumb-item"><a href="">Nuevo Artículo</a></li>
						</ul>
					</div>	
					<div class="d-flex justify-content-center">
						<div class="col-12 col-sm-10 col-md-8 col-lg-7 col-xl-5 "style="background-color: #DAEDF6">
							...
							<form action="/esis.library.unjbg/NuevoArticulo/InsertarArticulo" method="POST" enctype="multipart/form-data">
								...
								<div class="clearfix mb-3">
									...
									<?php 
										if($numautores < 1){
											header("Location: http://localhost/esis.library.unjbg/Articulo/MostrarArticulos");
										}
										else{
