					...
					<div>
						<div class="d-flex">
							<div class="float-left">
								<h4 style="color:#7C3A3A"><b>ESTUDIANTES</b></h4>
							</div>
							<div class="float-left">
						...
						<div class="mt-3">
							...
							<table class="table table-striped">
						      ...
						      <tbody>
						        <?php
						        while ($row = $estudiante->fetch_array())
						        {
						          echo '<tr>';
						          ...
						          echo "<td><a href='" . FOLDER_PATH ."/Estudiantes/MostrarUsuario/{$row['id_usuario']}'>Editar</a></td>";
						          echo "<td><a href='" . FOLDER_PATH ."/Estudiantes/EliminarUsuario/{$row['id_usuario']}'>Eliminar</a></td>";
						          echo '</tr>';
						        }
						        ?>
						      </tbody>
