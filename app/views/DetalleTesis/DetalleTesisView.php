				...
				<div class="col-md-9 col-lg-10 float-right">
					<div class="mt-3">
						<ul class="breadcrumb p-2">
							...
							<li class="breadcrumb-item"><a href="">Detalle de Tesis</a></li>
						</ul>
					</div>	
					<div>	
						<?php 
							$fila = $tesis->fetch_array();
						?>
						<div class="col-12 col-sm-4 float-left p-0">
							...
							<div class="d-flex justify-content-center mt-2">
								<a href="/esis.library.unjbg/ModificarTesis/CargarDatos/<?php echo $fila['id_texto'] ?>" class="btn btn-danger">Modificar</a>
							</div>
									...
									<div class="modal-dialog">
										<div class="modal-content">
											...
											<div class="modal-body px-0 text-center">
												...
												<form action="/esis.library.unjbg/DetalleTesis/InsertarEjemplar" method="POST">
													Nombre ejemplar: 
													<input type="text" name="nombreejemplar" autofocus required>
													<input type="hidden" name="idTesis" value="<?php echo $idTesis ?>">
