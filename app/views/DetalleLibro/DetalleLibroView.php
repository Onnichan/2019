				...
				<div class="col-md-9 col-lg-10 float-right">
					<div class="mt-3">
						<ul class="breadcrumb p-2">
							...
							<li class="breadcrumb-item"><a href="">Detalle de Libro</a></li>
						</ul>
					</div>	
					<div>	
						<?php 
						...
						<div class="col-12 col-sm-4 float-left p-0">
							...
							<div class="d-flex justify-content-center mt-2">
								<a href="/esis.library.unjbg/ModificarLibro/CargarDatos/<?php echo $fila['id_texto'] ?>" class="btn btn-danger">Modificar</a>
							</div>
									...
									<div class="modal-dialog">
										<div class="modal-content">
											...
											<div class="modal-body px-0 text-center">
												...
												<form action="/esis.library.unjbg/DetalleLibro/InsertarEjemplar" method="POST">
													Nombre ejemplar: 
						...
						<div class="col-12 col-sm-8 float-left p-0">
							<table class="table table-bordered table-striped col-lg-10 col-xl-8">
								...
								<tr>
									<th>Edición</th>
									<td><?php echo $fila['nombre_edicion'] ?></td>
								</tr>
								<tr>
									<th>Editorial</th>
