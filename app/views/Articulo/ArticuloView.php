					...
					<div>
						<div class="d-flex">
							<div class="float-left">
								<h4 style="color:#7C3A3A"><b>ARTÍCULOS</b></h4>
							</div>
							<div>
									...
									<div class="modal-dialog">
										<div class="modal-content">
											...
											<div class="modal-body px-0 text-center">
												...
												<form action="/esis.library.unjbg/NuevoArticulo/CargarDatos" method="POST">
													Cantidad: 
													<input type="text" name="cantidadautores" required autofocus>
													<div class="modal-footer mt-3 pb-0">
														<input type="submit" class="btn btn-primary" value="Insertar artículo">
													</div>
												</form>
											</div>
										</div>
						...
						<div class="mt-3">
							<table class="col-12 col-md-11 col-xl-10 table table-striped table-hover table-sm mx-auto">
								...
								<?php 
									while($fila = $articulo->fetch_array()){
										$tabla1 = "
										<tr>
										...
										$tabla2 = "
											...
											<td><a href=\"/esis.library.unjbg/DetalleArticulo/MostrarDetalleArticulo/$fila[id_texto]\">Ver detalle</a></td>
										</tr>";
