				...
				<div class="col-md-9 col-lg-10 float-right">
					<div class="mt-3">
						<ul class="breadcrumb p-2">
							...
							<li class="breadcrumb-item"><a href="">Modificar tesis</a></li>
						</ul>
					</div>	
					<div class="d-flex justify-content-center">
						<div class="col-12 col-sm-10 col-md-8 col-lg-7 col-xl-5 "style="background-color: #DAEDF6">
							...
							<div class="d-flex justify-content-center">
								<h3>MODIFICAR TESIS</h3>
							</div>
							<form action="/esis.library.unjbg/ModificarTesis/ActualizarTesis" method="POST" enctype="multipart/form-data">
								<?php 
									$filaT = $tesis->fetch_array();
								?>
								<input type="hidden" name="idTexto" value="<?php echo $filaT['id_texto'] ?>">
								<div class="form-group">
									<label for="nombre">Nombre tesis:</label>
									<input type="text" name="nombre" id="nombre" class="form-control form-control-sm" value="<?php echo $filaT['nombre_texto'] ?>" required>
								</div>
								...
								<div class="form-group">
									...
									<input type="number" name="publicacion" id="publicacion" class="form-control form-control-sm" value="<?php echo $filaT['fecha_publicacion'] ?>" required>
								</div>
								<div class="form-group">
									<label for="paginas">Número de páginas:</label>
									<input type="number" name="paginas" id="paginas" class="form-control form-control-sm" value="<?php echo $filaT['num_paginas'] ?>" required>
								</div>
								<div class="form-group">
									<label for="cantidad">Cantidad:</label>
									<input type="number" name="cantidad" id="cantidad" class="form-control form-control-sm" value="<?php echo $filaT['cantidad_total'] ?>" required>
								</div>
								<div class="form-group">
									<div>
									...
									<select name="grado" id="grado" class="custom-select custom-select-sm col-8">
										...
										while($fila = $grado->fetch_array()){
											...
											if(strcmp($fila['nombre_grado'], $filaT['nombre_grado']) == 0){
								...
								<div class="form-group">
									...
									<select name="genero" id="genero" class="custom-select custom-select-sm col-8">
										...
										while($fila = $genero->fetch_array()){
											...
											if(strcmp($fila['nombre_genero'], $filaT['nombre_genero']) == 0){
												$opcion = $opcion . "selected";
											}
